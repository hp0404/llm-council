...
async def stage1_collect_responses(
    user_query: str, council_models: list[str] = None
) -> list[dict[str, Any]]:
    """
    ...
    Args:
        ...
        council_models: List of model IDs to use (defaults to COUNCIL_MODELS from config)
...
async def stage3_synthesize_final(
    ...
    Args:
        ...
        chairman_model: Model ID for chairman (defaults to CHAIRMAN_MODEL from config)
...
async def run_full_council(
    user_query: str, council_models: list[str] = None, chairman_model: str = None
    ...
    Args:
        user_query: The user's question
        council_models: List of model IDs to use for council (defaults to config)
        chairman_model: Model ID for chairman (defaults to config)
